---
title: M2P Product Documentation
---
...
<Jumbotron>
  ...
  <H1>M2P Products Document</H1>
  <H2>A portal to get to know more on M2P Products</H2>
...
<Box my={25}>
  <SectionHeader>
    Get to know more about <Emphasis> M2P Products </Emphasis>!
  </SectionHeader>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/gold-deposits/index.md" icon={icon1} header="Gold Deposits">
    ...
    <ThinTile to="developer-portal/deposits/index.md" icon={launchFastIcon} header="Deposits">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </ThinTile>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <WideTile to="developer-portal/gold-deposits/index.md" header="Gold Deposits">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </WideTile>
    <WideTile to="developer-portal/deposits/index.md" header="Deposits">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </WideTile>
